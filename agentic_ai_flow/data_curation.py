"""
Loader for Amazon Reviews datasets from Hugging Face:
user "McAuley-Lab/Amazon-Reviews-2023",

save locally as a pickel file for faster loading next time data/train_lite.pkl anf data/test_lite.pkl
upload to Hugging Face dataset hub as private dataset "ktomiwacloudai/lite-data"
"""
